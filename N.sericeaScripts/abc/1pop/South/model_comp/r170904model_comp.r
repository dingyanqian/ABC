...
ss.model1 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/South/model1/sumstat_ESTSSR.txt", header = TRUE)

ss.model2 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/South/model2/sumstat_ESTSSR.txt", header = TRUE)

ss.model3 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/South/model3/sumstat_ESTSSR.txt", header = TRUE)

ss.model4 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/South/model4/sumstat_ESTSSR.txt", header = TRUE)
