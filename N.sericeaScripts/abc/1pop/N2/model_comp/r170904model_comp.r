...
ss.model1 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/N2/model1/sumstat_ESTSSR.txt", header = TRUE)

ss.model2 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/N2/model2/sumstat_ESTSSR.txt", header = TRUN2E)

ss.model3 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/N2/model3/sumstat_ESTSSR.txt", header = TRUE)

ss.model4 <- read.table(file = "/home/biosys/Desktop/ABC/abc/1pop/N2/model4/sumstat_ESTSSR.txt", header = TRUE)
