...
arl_run <- "/home/biosys/Desktop/ABC/abc/observed/1pop_N2/arl_run.ars" # path for arl_run.ars
ssdefs <- "/home/biosys/Desktop/ABC/abc/observed/1pop_N2/ssdefs.txt" # path for ssdefs.txt
