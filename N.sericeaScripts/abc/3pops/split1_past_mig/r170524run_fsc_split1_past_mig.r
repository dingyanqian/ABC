# Split1 model with migration between N (ancestral population of N1 and N2) and South
...
tpl.ESTSSR <- "model_split1_past_mig_ESTSSR.tpl" # path for tpl file of ESTSSR
