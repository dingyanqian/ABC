# split1 without any migration model
...
n.sim <- nrow(ss)
ss.data <- read.table(file = "/Users/a1993/Desktop/N.sericea/ABC/3lineages/abc/observed/3pops/observed_neolitsea3pops.txt", header = TRUE)
